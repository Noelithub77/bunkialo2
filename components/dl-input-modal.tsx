...
export function DLInputModal({ visible, onClose, onConfirm }: DLInputModalProps) {
      ...
      >
        ...
        <View style={[styles.modal, { backgroundColor: theme.background }]}>
          <View style={styles.header}>
            ...
            <Text style={[styles.title, { color: theme.text }]}>Mark as Duty Leave</Text>
          </View>
          ...
          <View style={styles.actions}>
            ...
            <Button title="Mark DL" onPress={handleConfirm} style={styles.btn} />
          </View>
        </View>
      </KeyboardAvoidingView>
    </Modal>
