...
export function TotalAbsenceCalendar({ onMarkPresent, onMarkDL }: TotalAbsenceCalendarProps) {
    ...
    const selectedAbsences = selectedDate ? absenceMap.get(selectedDate) || [] : []
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={[styles.summary, { backgroundColor: theme.backgroundSecondary }]}>
                <Text style={[styles.summaryLabel, { color: theme.textSecondary }]}>Total Bunks</Text>
                <Text style={[styles.summaryValue, { color: Colors.status.danger }]}>{totalAbsences}</Text>
            </View>
                        ...
                        <ScrollView style={styles.scrollList} showsVerticalScrollIndicator={false}>
                            {selectedAbsences.map((absence, idx) => (
                                <View key={idx} style={styles.slotWrapper}>
                                    <Text style={[styles.courseLabel, { color: absence.courseColor }]}>
                                        {absence.courseName}
                                    </Text>
                                    <SwipeableAttendanceSlot
                                        ...
                                        onMarkPresent={() => onMarkPresent?.(absence.courseId, absence.record)}
                                        onMarkDL={() => onMarkDL?.(absence.courseId, absence.record)}
                                    />
                                </View>
                            ))}
                        </ScrollView>
