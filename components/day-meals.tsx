    ...
    return (
        <View style={styles.container}>
            {dayMenu.meals.map((meal, index) => {
                ...
                const isNow = isToday && currentTime >= meal.startTime && currentTime < meal.endTime
                        ...
                        >
                            <View style={styles.cardHeader}>
                                <View style={styles.titleRow}>
                                    ...
                                    />
                                    <Text style={[styles.mealName, { color: isPast ? theme.textSecondary : theme.text }]}>
                                        {meal.name}
                                    </Text>
                                </View>
                                {isNow && (
                            ...
                            <View style={styles.itemsContainer}>
                                {meal.items.map((item, i) => (
                                    <View key={i} style={[styles.itemChip, { backgroundColor: theme.backgroundSecondary }]}>
                                        <Text style={[styles.itemText, { color: isPast ? theme.textSecondary : theme.text }]}>
                                            {item}
                                        </Text>
                                    </View>
                                ))}
