...
export function PresenceInputModal({ visible, onClose, onConfirm }: PresenceInputModalProps) {
            ...
            >
                ...
                <View style={[styles.modal, { backgroundColor: theme.background }]}>
                    <View style={styles.header}>
                        ...
                        <Text style={[styles.title, { color: theme.text }]}>Mark as Present</Text>
                    </View>
                    ...
                    <View style={styles.actions}>
                        ...
                        <Button title="Mark Present" onPress={handleConfirm} style={styles.btn} />
                    </View>
                </View>
            </KeyboardAvoidingView>
        </Modal>
