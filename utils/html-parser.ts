...
export const querySelectorAll = (doc: Document | Element, selector: string): Element[] => {
  return selectAll(selector, doc) as Element[]
}

// Select first element matching a CSS selector
export const querySelector = (doc: Document | Element, selector: string): Element | null => {
...
export const getAttr = (element: Element | null, attr: string): string | null => {
  if (!element) return null
  return getAttributeValue(element, attr) ?? null
}

// Check if any elements match the selector
export const hasMatch = (doc: Document | Element, selector: string): boolean => {
