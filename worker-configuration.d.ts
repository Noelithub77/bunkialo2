/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 44d715ae1c9f590ed978068f763115d3)
// Runtime types generated with workerd@1.20260811.1 2026-08-11 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	ASSETS: Fetcher;
	ATTENDANCE_PORTAL_URL: "https://attendance.iiitkottayam.ac.in";
	VAPID_ADMIN_CONTACT: "mailto:noelmcv7@gmail.com";
	VAPID_PRIVATE_KEY: string;
	USER_SESSION: DurableObjectNamespace<import("./worker/index").UserSession>;
	DESKTOP_DIRECTORY: DurableObjectNamespace<import("./worker/index").DesktopDirectory>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "UserSession" | "DesktopDirectory";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ATTENDANCE_PORTAL_URL" | "VAPID_ADMIN_CONTACT" | "VAPID_PRIVATE_KEY">> {}
}
