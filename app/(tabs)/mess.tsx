        ...
        <Container>
            ...
            >
                ...
                <View style={styles.header}>
                    <Text style={[styles.screenTitle, { color: theme.text }]}>Mess Menu</Text>
                </View>
                ...
                <View style={styles.scheduleSection}>
                    <Text style={[styles.sectionTitle, { color: theme.text, marginTop: 0 }]}>Today's Menu</Text>
                    <MealDaySelector selectedDay={selectedDay} onSelect={setSelectedDay} />
